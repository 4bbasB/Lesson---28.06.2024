...
--TASK 1
SELECT Employees.EmployeeID, COUNT(OrderID) AS 'OrderCount', CONCAT(Employees.FirstName, ' ', Employees.LastName) AS 'Employee Fullname'  From Employees
INNER JOIN Orders
...
--TASK 2
SELECT OrderID as 'OrderId', ProductName AS 'ProductName', Price * OrderDetails.Quantity AS 'TotalPrice' 
FROM Products
INNER JOIN OrderDetails
ON OrderDetails.ProductID = Products.ProductID
GROUP BY OrderID, ProductName, Price, Quantity


--TASK 3
SELECT OrderID as 'OrderId', Price * OrderDetails.Quantity AS 'TotalPrice' 
FROM Products
INNER JOIN OrderDetails
...
--TASK 4
SELECT Employees.EmployeeID, CONCAT(Employees.FirstName, ' ', Employees.LastName) AS 'Employee Fullname', SUM(Price * OrderDetails.Quantity) AS 'TotalSalePrice'  From Employees
INNER JOIN Orders
ON Orders.EmployeeID = Employees.EmployeeID
INNER JOIN OrderDetails
...
--TASK 5
SELECT TOP 5 ProductName, SUM(OrderDetails.Quantity) AS TotalQuantitySold 
FROM Products
INNER JOIN OrderDetails
ON OrderDetails.ProductID = Products.ProductID
...
--TASK 6
SELECT Customers.CustomerName, SUM(Price * OrderDetails.Quantity) AS [TotalOrderPrice]
FROM Customers
JOIN Orders
...
HAVING SUM(Products.Price * OrderDetails.Quantity) > 20000
